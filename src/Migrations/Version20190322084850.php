 ...
 */
final class Version20190322084850 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sf_order DROP INDEX FK_6148EE624C3A3BB, ADD UNIQUE INDEX UNIQ_6148EE624C3A3BB (payment_id)');
        $this->addSql('ALTER TABLE sf_order DROP FOREIGN KEY FK_6148EE6219EB6921');
        $this->addSql('ALTER TABLE sf_order ADD shipping_cost DOUBLE PRECISION DEFAULT NULL, CHANGE delivery_date delivery_date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE sf_order ADD CONSTRAINT FK_6148EE6219EB6921 FOREIGN KEY (client_id) REFERENCES sf_user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sf_order DROP INDEX UNIQ_6148EE624C3A3BB, ADD INDEX FK_6148EE624C3A3BB (payment_id)');
        $this->addSql('ALTER TABLE sf_order DROP FOREIGN KEY FK_6148EE6219EB6921');
        $this->addSql('ALTER TABLE sf_order DROP shipping_cost, CHANGE delivery_date delivery_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE sf_order ADD CONSTRAINT FK_6148EE6219EB6921 FOREIGN KEY (client_id) REFERENCES sf_user (id) ON UPDATE CASCADE ON DELETE CASCADE');
